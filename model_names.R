...
model_variant = mget(c("model_c3_2", "model_c3_4", "model_c5_1", "model_c5_2", "model_c5_3", "model_c5_4", "model_c5_5", "model_c5_6", "model_manuf_3"))
...
test_model_variant = lapply(seq_along(model_variant), function(i) {
  rmse_prev(formula = get_formula_variants[[i]], data = data, var_fixes = fixed_coef_variants[[i]])
})
